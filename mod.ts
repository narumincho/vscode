 ...
 */ export type VSCodeAPI = {
   ...
   */ readonly RelativePattern: {
     ...
     */ new (
      base: WorkspaceFolder | Uri | string,
      pattern: string,
    ): RelativePattern;
  };
  /**
   ...
   */ readonly EvaluatableExpression: {
    /**
   ...
   */ readonly InlineValueVariableLookup: {
    /**
   ...
   * If only a range is specified, the expression will be extracted from the underlying document.
   * An optional expression can be used to override the extracted expression.
   */ readonly InlineValueEvaluatableExpression: {
    /**
   ...
   * in the editor.
   */ readonly CompletionList: {
    /**
     * Creates a new completion list.
     *
     * @param items The completion items.
     * @param isIncomplete The list is not complete.
     */ new <T extends CompletionItem = CompletionItem>(
      items?: T[],
   ...
   */ readonly CallHierarchyIncomingCall: {
    /**
   ...
   */ readonly CallHierarchyOutgoingCall: {
    /**
     * Create a new call object.
     *
   ...
   */ readonly DocumentDropOrPasteEditKind: {
    readonly Empty: DocumentDropOrPasteEditKind;
    /**
   ...
   */ readonly DocumentPasteTriggerKind: {
    /**
   ...
   */ readonly TerminalShellExecutionCommandLineConfidence: {
    /**
   ...
   */ readonly window: {
     ...
     */ readonly onDidChangeTextEditorVisibleRanges: Event<
     ...
     * has changed.
     */ readonly onDidChangeVisibleNotebookEditors: Event<
     ...
     */ readonly onDidChangeTerminalShellIntegration: Event<
     ...
     */ readonly onDidStartTerminalShellExecution: Event<
     ...
     * [shell integration](https://code.visualstudio.com/docs/terminal/shell-integration) is
     * activated for the terminal.
     */ readonly onDidEndTerminalShellExecution: Event<
   ...
   */ readonly workspace: {
     ...
     *
     * The current thresholds are 1.5 seconds as overall time budget and a listener can misbehave 3 times before being ignored.
     */ readonly onWillSaveNotebookDocument: Event<
   ...
   */ readonly NotebookCellOutputItem: {
    /**
   ...
   */ readonly DebugAdapterNamedPipeServer: {
    /**
   ...
   */ readonly DebugAdapterInlineImplementation: {
    /**
   ...
   */ readonly DebugThread: {
    /**
     * @hidden
     */ new (session: DebugSession, threadId: number): DebugThread;
  };
  /**
   * Represents a stack frame in a debug session.
   */ readonly DebugStackFrame: {
    /**
     * @hidden
     */ new (
   ...
   */ readonly debug: {
     ...
     */ readonly activeStackItem: DebugThread | DebugStackFrame | undefined;
    /**
   ...
   */ readonly TestMessageStackFrame: {
    /**
   ...
   */ readonly ChatResultFeedbackKind: {
    /**
     * The user marked the result as unhelpful.
     */ readonly Unhelpful: 0;
    /**
   ...
   */ readonly ChatResponseMarkdownPart: {
    /**
     * Create a new ChatResponseMarkdownPart.
     *
     * @param value A markdown string or a string that should be interpreted as markdown. The boolean form of {@link MarkdownString.isTrusted} is NOT supported.
     */ new (value: string | MarkdownString): ChatResponseMarkdownPart;
  };
  /**
   * Represents a part of a chat response that is a file tree.
   */ readonly ChatResponseFileTreePart: {
    /**
   ...
   */ readonly ChatResponseAnchorPart: {
    /**
     * Create a new ChatResponseAnchorPart.
     * @param value A uri or location.
     * @param title An optional title that is rendered with value.
     */ new (value: Uri | Location, title?: string): ChatResponseAnchorPart;
  };
  /**
   * Represents a part of a chat response that is a progress message.
   */ readonly ChatResponseProgressPart: {
    /**
     * Create a new ChatResponseProgressPart.
     * @param value A progress message
     */ new (value: string): ChatResponseProgressPart;
  };
  /**
   * Represents a part of a chat response that is a reference, rendered separately from the content.
   */ readonly ChatResponseReferencePart: {
    /**
   ...
   */ readonly ChatResponseCommandButtonPart: {
    /**
     * Create a new ChatResponseCommandButtonPart.
     * @param value A Command that will be executed when the button is clicked.
     */ new (value: Command): ChatResponseCommandButtonPart;
  };
  /**
   ...
   */ readonly LanguageModelChatMessageRole: {
    /**
   ...
   */ readonly LanguageModelToolCallPart: {
    /**
   ...
   */ readonly LanguageModelToolResultPart: {
    /**
     * @param callId The ID of the tool call.
   ...
   */ readonly LanguageModelTextPart: {
    /**
...
/**
 * Represents sources that can cause {@link window.onDidChangeTextEditorSelection selection change events}.
 */ export type TextEditorSelectionChangeKind = ValueOf<
  VSCodeAPI["TextEditorSelectionChangeKind"]
>;
/**
...
/**
 * Rendering style of the cursor.
 */ export type TextEditorCursorStyle = ValueOf<
  VSCodeAPI["TextEditorCursorStyle"]
>;
/**
 * Rendering style of the line numbers.
 */ export type TextEditorLineNumbersStyle = ValueOf<
  VSCodeAPI["TextEditorLineNumbersStyle"]
>;
/**
...
/**
 * Represents different {@link TextEditor.revealRange reveal} strategies in a text editor.
 */ export type TextEditorRevealType = ValueOf<
  VSCodeAPI["TextEditorRevealType"]
>;
/**
 * Represents different positions for rendering a decoration in an {@link DecorationRenderOptions.overviewRulerLane overview ruler}.
 * The overview ruler supports three lanes.
...
/**
 * Describes the behavior of decorations when typing/editing at their edges.
 */ export type DecorationRangeBehavior = ValueOf<
  VSCodeAPI["DecorationRangeBehavior"]
>;
/**
...
/**
 * The severity level for input box validation.
 */ export type InputBoxValidationSeverity = ValueOf<
  VSCodeAPI["InputBoxValidationSeverity"]
>;
/**
...
/**
 * The reason why code actions were requested.
 */ export type CodeActionTriggerKind = ValueOf<
  VSCodeAPI["CodeActionTriggerKind"]
>;
/**
...
/**
 * A document highlight kind.
 */ export type DocumentHighlightKind = ValueOf<
  VSCodeAPI["DocumentHighlightKind"]
>;
/**
 * A document highlight is a range inside a text document which deserves
 * special attention. Usually a document highlight is visualized by changing
...
/**
 * How a {@linkcode SignatureHelpProvider} was triggered.
 */ export type SignatureHelpTriggerKind = ValueOf<
  VSCodeAPI["SignatureHelpTriggerKind"]
>;
/**
...
/**
 * How a {@link CompletionItemProvider completion provider} was triggered
 */ export type CompletionTriggerKind = ValueOf<
  VSCodeAPI["CompletionTriggerKind"]
>;
/**
...
/**
 * Describes how an {@link InlineCompletionItemProvider inline completion provider} was triggered.
 */ export type InlineCompletionTriggerKind = ValueOf<
  VSCodeAPI["InlineCompletionTriggerKind"]
>;
/**
 * An inline completion item represents a text snippet that is proposed inline to complete text that is being typed.
 *
...
/**
 * Identifies a {@linkcode DocumentDropEdit} or {@linkcode DocumentPasteEdit}
 */ export type DocumentDropOrPasteEditKind = {
  /**
...
/**
 * The reason why paste edits were requested.
 */ export type DocumentPasteTriggerKind = ValueOf<
  VSCodeAPI["DocumentPasteTriggerKind"]
>;
/**
...
/**
 * Represents the severity level of a language status.
 */ export type LanguageStatusSeverity = ValueOf<
  VSCodeAPI["LanguageStatusSeverity"]
>;
/**
...
/**
 * The confidence of a {@link TerminalShellExecutionCommandLine} value.
 */ export type TerminalShellExecutionCommandLineConfidence = ValueOf<
  VSCodeAPI["TerminalShellExecutionCommandLineConfidence"]
>;
/**
...
/**
 * Collapsible state of the tree item
 */ export type TreeItemCollapsibleState = ValueOf<
  VSCodeAPI["TreeItemCollapsibleState"]
>;
/**
...
/**
 * A type of mutation that can be applied to an environment variable.
 */ export type EnvironmentVariableMutatorType = ValueOf<
...
/**
 * Reasons for why a text document has changed.
 */ export type TextDocumentChangeReason = ValueOf<
  VSCodeAPI["TextDocumentChangeReason"]
>;
/**
...
/**
 * Represents reasons why a text document is saved.
 */ export type TextDocumentSaveReason = ValueOf<
  VSCodeAPI["TextDocumentSaveReason"]
>;
/**
...
/**
 * Represents a notebook editor that is attached to a {@link NotebookDocument notebook}.
 */ export type NotebookEditorRevealType = ValueOf<
  VSCodeAPI["NotebookEditorRevealType"]
>;
/**
 * Represents a notebook editor that is attached to a {@link NotebookDocument notebook}.
 ...
 *
 * @see {@link NotebookController.updateNotebookAffinity}
 */ export type NotebookControllerAffinity = ValueOf<
  VSCodeAPI["NotebookControllerAffinity"]
>;
/**
...
/**
 * Represents the alignment of status bar items.
 */ export type NotebookCellStatusBarAlignment = ValueOf<
  VSCodeAPI["NotebookCellStatusBarAlignment"]
>;
/**
 * A contribution to a cell's status bar
 ...
 * to provide dynamically generated debug configurations when the user asks for them through the UI (e.g. via the "Select and Start Debugging" command).
 * A trigger kind is used when registering a `DebugConfigurationProvider` with {@link debug.registerDebugConfigurationProvider}.
 */ export type DebugConfigurationProviderTriggerKind = ValueOf<
  VSCodeAPI["DebugConfigurationProviderTriggerKind"]
>;
/**
 * Represents a thread in a debug session.
...
/**
 * Collapsible state of a {@link CommentThread comment thread}
 */ export type CommentThreadCollapsibleState = ValueOf<
  VSCodeAPI["CommentThreadCollapsibleState"]
>;
/**
 * Comment mode of a {@link Comment}
...
/**
 * Represents the type of user feedback received.
 */ export type ChatResultFeedbackKind = ValueOf<
  VSCodeAPI["ChatResultFeedbackKind"]
>;
/**
...
/**
 * Represents a part of a chat response that is formatted as Markdown.
 */ export type ChatResponseMarkdownPart = {
  /**
...
/**
 * Represents a part of a chat response that is a file tree.
 */ export type ChatResponseFileTreePart = {
  /**
   * File tree data.
   */ value: ChatResponseFileTree[];
  /**
...
/**
 * Represents a part of a chat response that is an anchor, that is rendered as a link to a target.
 */ export type ChatResponseAnchorPart = {
  /**
...
/**
 * Represents a part of a chat response that is a progress message.
 */ export type ChatResponseProgressPart = {
  /**
...
/**
 * Represents a part of a chat response that is a reference, rendered separately from the content.
 */ export type ChatResponseReferencePart = {
  /**
...
/**
 * Represents a part of a chat response that is a button that executes a command.
 */ export type ChatResponseCommandButtonPart = {
  /**
...
/**
 * Represents the role of a chat message. This is either the user or the assistant.
 */ export type LanguageModelChatMessageRole = ValueOf<
  VSCodeAPI["LanguageModelChatMessageRole"]
>;
/**
 * Represents a message in a chat. Can assume different roles, like user or assistant.
 ...
 * for the case of referring to an unknown language model. For unspecified errors the `cause`-property
 * will contain the actual error.
 */ export type LanguageModelError = Error & {
  /**
   * A code that identifies this error.
   *
...
/**
 * A tool-calling mode for the language model to use.
 */ export type LanguageModelChatToolMode = ValueOf<
  VSCodeAPI["LanguageModelChatToolMode"]
>;
/**
 * A language model response part indicating a tool call, returned from a {@link LanguageModelChatResponse}, and also can be
 * included as a content part on a {@link LanguageModelChatMessage}, to represent a previous tool call in a chat request.
...
/**
 * A language model response part containing a piece of text, returned from a {@link LanguageModelChatResponse}.
 */ export type LanguageModelTextPart = {
  /**
 ...
 * A language model response part containing a PromptElementJSON from `@vscode/prompt-tsx`.
 * @see {@link LanguageModelToolResult}
 */ export type LanguageModelPromptTsxPart = {
  /**
