 ...
 */ export type VSCodeAPI = {
	 ...
	 */ readonly ChatRequestTurn: {
        /**
		 * @hidden
		 */ new(prompt: string, command: string | undefined, references: ChatPromptReference[], participant: string): ChatRequestTurn;
    };
    /**
	 ...
	 */ readonly LanguageModelChatMessage: {
		 ...
		 * @param content The content of the message.
		 * @param name The optional name of a user for the message.
		 */ new(role: LanguageModelChatMessageRole, content: string, name?: string): LanguageModelChatMessage;
    };
    /**
