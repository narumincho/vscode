 ...
 */ export type VSCodeAPI = {
	 ...
	 */ readonly DocumentDropEdit: {
		 ...
		 */ new(insertText: string | SnippetString, title?: string, kind?: DocumentDropOrPasteEditKind): DocumentDropEdit;
    };
    /**
	 ...
	 */ readonly DocumentPasteEdit: {
		 ...
		 * @param title Human readable label that describes the edit.
		 * @param kind {@link DocumentDropOrPasteEditKind Kind} of the edit.
		 */ new(insertText: string | SnippetString, title: string, kind: DocumentDropOrPasteEditKind): DocumentPasteEdit;
    };
    /**
	 ...
	 */ readonly languages: {
		 ...
		 */ registerDocumentDropEditProvider(selector: DocumentSelector, provider: DocumentDropEditProvider, metadata?: DocumentDropEditProviderMetadata): Disposable;
        /**
		 ...
		 *
		 * @returns A {@linkcode Disposable} that unregisters this provider when disposed of.
		 */ registerDocumentPasteEditProvider(selector: DocumentSelector, provider: DocumentPasteEditProvider, metadata: DocumentPasteProviderMetadata): Disposable;
        /**
	 ...
	 */ readonly DebugStackFrame: {
        /**
		 * @hidden
		 */ new(session: DebugSession, threadId: number, frameId: number): DebugStackFrame;
    };
    /**
	 ...
	 */ readonly debug: {
		 ...
		 */ readonly onDidChangeActiveStackItem: Event<DebugThread | DebugStackFrame | undefined>;
        /**
	 ...
	 */ readonly TestRunRequest: {
		 ...
		 */ new(include?: readonly TestItem[], exclude?: readonly TestItem[], profile?: TestRunProfile, continuous?: boolean, preserveFocus?: boolean): TestRunRequest;
    };
    /**
	 ...
	 */ readonly TestMessageStackFrame: {
		 ...
		 */ new(label: string, uri?: Uri, position?: Position): TestMessageStackFrame;
    };
    /**
	 ...
	 */ readonly StatementCoverage: {
		 ...
		 */ new(executed: number | boolean, location: Position | Range, branches?: BranchCoverage[]): StatementCoverage;
    };
    /**
	 ...
	 */ readonly BranchCoverage: {
		 ...
		 */ new(executed: number | boolean, location?: Position | Range, label?: string): BranchCoverage;
    };
    /**
	 ...
	 */ readonly DeclarationCoverage: {
		 ...
		 */ new(name: string, executed: number | boolean, location: Position | Range): DeclarationCoverage;
    };
    /**
	 ...
	 */ readonly ChatRequestTurn: {
        /**
		 * @hidden
		 */ new(prompt: string, command: string | undefined, references: ChatPromptReference[], participant: string, toolReferences: ChatLanguageModelToolReference[]): ChatRequestTurn;
    };
    /**
	 ...
	 */ readonly ChatResponseTurn: {
        /**
		 * @hidden
		 */ new(response: ReadonlyArray<ChatResponseMarkdownPart | ChatResponseFileTreePart | ChatResponseAnchorPart | ChatResponseCommandButtonPart>, result: ChatResult, participant: string): ChatResponseTurn;
    };
    /**
	 ...
	 */ readonly ChatResponseFileTreePart: {
		 ...
		 */ new(value: ChatResponseFileTree[], baseUri: Uri): ChatResponseFileTreePart;
    };
    /**
	 ...
	 */ readonly LanguageModelToolCallPart: {
		 ...
		 */ new(callId: string, name: string, input: object): LanguageModelToolCallPart;
    };
    /**
...
/**
	 * The reason why paste edits were requested.
	 */ export type DocumentPasteTriggerKind = ValueOf<VSCodeAPI["DocumentPasteTriggerKind"]>;
/**
...
/**
	 * The confidence of a {@link TerminalShellExecutionCommandLine} value.
	 */ export type TerminalShellExecutionCommandLineConfidence = ValueOf<VSCodeAPI["TerminalShellExecutionCommandLineConfidence"]>;
/**
...
/**
	 * Represents the type of user feedback received.
	 */ export type ChatResultFeedbackKind = ValueOf<VSCodeAPI["ChatResultFeedbackKind"]>;
/**
...
/**
	 * Represents the role of a chat message. This is either the user or the assistant.
	 */ export type LanguageModelChatMessageRole = ValueOf<VSCodeAPI["LanguageModelChatMessageRole"]>;
/**
	 * Represents a message in a chat. Can assume different roles, like user or assistant.
...
/**
	 * A tool-calling mode for the language model to use.
	 */ export type LanguageModelChatToolMode = ValueOf<VSCodeAPI["LanguageModelChatToolMode"]>;
/**
	 * A language model response part indicating a tool call, returned from a {@link LanguageModelChatResponse}, and also can be
	 * included as a content part on a {@link LanguageModelChatMessage}, to represent a previous tool call in a chat request.
